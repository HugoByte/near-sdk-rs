...
mod mock_chain {
    ...
    #[no_mangle]
    extern "C" fn ecrecover(hash_len: u64, hash_ptr: u64, sig_len: u64, sig_ptr: u64, v: u64, malleability_flag: u64, register_id: u64) -> u64 {
        with_mock_interface(|b| b.ecrecover(hash_len, hash_ptr, sig_len, sig_ptr, v, malleability_flag, register_id))
    }
    #[no_mangle]
